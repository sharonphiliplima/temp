...
contract PriceFeed is IPriceFeed {
    ...
    // q why is this immutable?
    // e https://github.com/sherlock-audit/2023-04-jojo-judging/issues/274
    // @audit
    ...
    function getPrice() external view returns (uint256) {
        if (address(sequencerUptimeFeed) != address(0)) {
            ...
            // e Using latestAnswer() is not recommended — use latestRoundData() instead
            // This function latestAnswer() does not tell us the last time the price updated. 
            // If price updates are delayed, the smart contract might make decisions based on outdated prices.
